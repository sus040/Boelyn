...
parser = argparse.ArgumentParser(description=("Load hospital quality data"
                                              "into the database."))
parser.add_argument('date', type=str, help="Date of the quality data"
                    "(YYYY-MM-DD)")
        ...
        with psycopg2.connect(
            ...
            with conn.cursor() as cursor:
                ...
                if result and result[0]:
                    print("Table 'quality' exists. Proceeding with data"
                          "insertion.")
                else:
                    ...
                    cursor.execute(
                        "INSERT INTO quality (Facility_ID, hospital_type, \
                            hospital_ownership, emergency_services, \
                                quality_rating, rating_date) VALUES (%s, %s, \
                                    %s, %s, %s, %s)",
